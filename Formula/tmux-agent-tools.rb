class TmuxAgentTools < Formula
  ...
  url "https://github.com/ohyeh/tmux-agent-tools/archive/refs/tags/v0.36.0.tar.gz"
  sha256 "706b52d8b42184a1608c8cfa2fab004e879b7991f95c88cb14ad6a17dcccb1f7"
  ...
  test do
    assert_match "agent-tmux - run Claude Code in tmux", shell_output("#{bin}/agent-tmux claude help")
    assert_match "agent-tmux - run Claude Code in tmux", shell_output("#{bin}/agent-tmux codex help")
